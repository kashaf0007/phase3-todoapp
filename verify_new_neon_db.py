...
def verify_table_exists():
    ...
    if "task" in tables:
        print("SUCCESS: The 'task' table exists in your Neon database!")
        ...
        print("ERROR: The 'task' table does not exist in your Neon database.")
        return False
...
def test_crud_operations():
    ...
    with Session(engine) as session:
        ...
        print(f"SUCCESS: Created task with ID: {test_task.id}")
        ...
        if result:
            print(f"SUCCESS: Retrieved task: {result.title}")
        ...
        print(f"SUCCESS: Updated task completion status to: {result.completed}")
        
        # Delete the task
        session.delete(result)
        session.commit()
        
        print("SUCCESS: Deleted the test task")
        
        return True

if __name__ == "__main__":
    print("Verifying table creation in your Neon database...\n")
